...
> Forked from [alberduris/claude-code-marketplace](https://github.com/alberduris/claude-code-marketplace). Original author: [@alberduris](https://x.com/alberduris).
...
```bash
# 1. Clone the repo
git clone https://github.com/pancakeswap/MKT-skills
cd MKT-skills/plugins/x-twitter
